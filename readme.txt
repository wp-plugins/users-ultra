...
= 1.3.35 (09-25-2014) =
* Improvements - The Social Login features have been improved. Now there is a now option within the admin panel that allows admin to automatically approve accounts when using facebook, twitter, google, yahoo etc etc.
